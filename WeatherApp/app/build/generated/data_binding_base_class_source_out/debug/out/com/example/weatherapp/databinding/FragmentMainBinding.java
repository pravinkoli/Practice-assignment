...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull FrameLayout rootView, @NonNull EditText city,
      @NonNull Button showButton) {
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMainBinding((FrameLayout) rootView, city, showButton);
    }
